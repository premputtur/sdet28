...
public class CreateTheProductInformationTest {
	...
	// read the common data from property file
		...
		// read the data from excel sheet
		 ...
		 Sheet sheet = workbook.getSheet("Sheet1");
			...
			driver.findElement(By.name("productname")).sendKeys("Book");
			driver.findElement(By.id("qtyinstock")).sendKeys("23");
...
//			driver.findElement(By.name("assigned_group_id")).click();
			...
			if(actualProductName.contains("Book")) {
